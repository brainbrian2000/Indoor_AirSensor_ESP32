# 1 "E:\\.NTU\\IPCS\\airsensor\\test_code\\test_code.ino"
# 2 "E:\\.NTU\\IPCS\\airsensor\\test_code\\test_code.ino" 2
# 3 "E:\\.NTU\\IPCS\\airsensor\\test_code\\test_code.ino" 2
# 4 "E:\\.NTU\\IPCS\\airsensor\\test_code\\test_code.ino" 2
# 5 "E:\\.NTU\\IPCS\\airsensor\\test_code\\test_code.ino" 2
# 6 "E:\\.NTU\\IPCS\\airsensor\\test_code\\test_code.ino" 2

# 8 "E:\\.NTU\\IPCS\\airsensor\\test_code\\test_code.ino" 2
# 9 "E:\\.NTU\\IPCS\\airsensor\\test_code\\test_code.ino" 2
# 10 "E:\\.NTU\\IPCS\\airsensor\\test_code\\test_code.ino" 2
# 11 "E:\\.NTU\\IPCS\\airsensor\\test_code\\test_code.ino" 2
# 12 "E:\\.NTU\\IPCS\\airsensor\\test_code\\test_code.ino" 2
// #include <EEPROM.h>
...
void setup() {
  ...
  delay(10);
  esp_sleep_enable_timer_wakeup(4 /* Time ESP32 will go to sleep (in seconds) */ * 1000000 /* Conversion factor for micro seconds to seconds */);
  // Pay attention to this command, with this wake up source
  // your device can't go to hibernate mode
  // but only deep sleep
  Serial.println("Setup ESP32 to sleep for every " + String(4 /* Time ESP32 will go to sleep (in seconds) */+1) +
  " Seconds");
  delay(10);
  ...
  if(workstate==0){
    ...
    if(rfid.scan()){
      ...
      for (byte i = 0; i < rfid.mfrc522.uid.size; i++) {
        ...
        Serial.print(rfid.mfrc522.uid.uidByte[i], 16);
      }
      Serial.print("\n");
